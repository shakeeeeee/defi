...
contract Zshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 ZSHAREs
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("Zilla Shares 2.0", "ZSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Zilla Shares for initial pools deployment
